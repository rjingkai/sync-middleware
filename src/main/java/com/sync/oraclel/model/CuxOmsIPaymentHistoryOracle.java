package com.sync.oraclel.model;

import java.math.BigDecimal;
import java.util.Date;

/**
* @ClassName: CuxOmsIPaymentHistoryOracle 
* @Description: Oracle流水表实例化对象
* @author NingChongQing
* @date 2018年4月4日 上午11:04:04
 */
public class CuxOmsIPaymentHistoryOracle {
